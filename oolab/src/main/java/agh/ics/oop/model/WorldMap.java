 ...
 * Assumes that P represents positions and T represent type of object on the map.
 */
public interface WorldMap<T,P> extends MoveValidator<P> {
     ...
     * @return True if the animal was placed. The object cannot be placed if the move is not valid.
     */
    ...
    void createObjectsList(List<P> positions, List<T> objects);
}